...
var loadRemote = function(url, scope, bustRemoteEntryCache) {
  return new Promise(function(resolve, reject) {
    var timestamp = bustRemoteEntryCache
      ? '?t='.concat(new Date().getTime())
      : '';
    var webpackRequire = __webpack_require__;
    webpackRequire.l(
      ''.concat(url).concat(timestamp),
      function(event) {
        var _a;
        if (
          (event === null || event === void 0 ? void 0 : event.type) === 'load'
        ) {
    ...
    return tslib_1.__generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          if (
            !!(webpackShareScopes === null || webpackShareScopes === void 0
              ? void 0
    ...
    return tslib_1.__generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          webpackShareScopes = __webpack_share_scopes__;
          if (
            !(!containerScope.__initialized && !containerScope.__initializing)
          )
            return [3 /*break*/, 2];
...
var importRemote = function(_a) {
  var url = _a.url,
    scope = _a.scope,
    module = _a.module,
    _b = _a.remoteEntryFileName,
    remoteEntryFileName = _b === void 0 ? REMOTE_ENTRY_FILE : _b,
    _c = _a.bustRemoteEntryCache,
    bustRemoteEntryCache = _c === void 0 ? true : _c;
  return tslib_1.__awaiter(void 0, void 0, void 0, function() {
      ...
      switch (_e.label) {
        ...
        case 3:
          ...
          return [
            ...
            Promise.all([
              loadRemote(
                ''.concat(remoteUrl, '/').concat(remoteEntryFileName),
                scope,
        ...
        case 4:
          ...
          if (!window[remoteScope]) {
            throw new Error(
              'Remote loaded successfully but '.concat(
                scope,
                ' could not be found! Verify that the name is correct in the Webpack configuration!'
              )
            );
          }
          return [
