...
webpack: [ -n "$NODE_ENV" ] && npx webpack serve --config config/webpack.config.js $WEBPACK_OPTS || env NODE_ENV=development npx webpack serve --config config/webpack.config.js $WEBPACK_OPTS
