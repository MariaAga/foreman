"use strict";
(self["webpackChunklanding"] = self["webpackChunklanding"] || []).push([["vendors-node_modules_patternfly_react-core_dist_esm_components_Tooltip_Tooltip_js"],{
...
/* harmony import */ var _patternfly_react_styles_css_components_Tooltip_tooltip__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @patternfly/react-styles/css/components/Tooltip/tooltip */ "./node_modules/@patternfly/react-styles/css/components/Tooltip/tooltip.mjs");
...
/* harmony import */ var _TooltipContent__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./TooltipContent */ "./node_modules/@patternfly/react-core/dist/esm/components/Tooltip/TooltipContent.js");
/* harmony import */ var _TooltipArrow__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./TooltipArrow */ "./node_modules/@patternfly/react-core/dist/esm/components/Tooltip/TooltipArrow.js");
...
/* harmony import */ var _helpers_Popper_Popper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../helpers/Popper/Popper */ "./node_modules/@patternfly/react-core/dist/esm/helpers/Popper/Popper.js");
...
const Tooltip = (_a) => {
    ...
    const content = (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", Object.assign({ "aria-live": ariaLive, className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(_patternfly_react_styles_css_components_Tooltip_tooltip__WEBPACK_IMPORTED_MODULE_4__["default"].tooltip, className), role: "tooltip", id: id, style: {
        ...
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_TooltipArrow__WEBPACK_IMPORTED_MODULE_6__.TooltipArrow, null),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_TooltipContent__WEBPACK_IMPORTED_MODULE_7__.TooltipContent, { isLeftAligned: isContentLeftAligned }, bodyContent)));
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _patternfly_react_styles_css_components_Tooltip_tooltip__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @patternfly/react-styles/css/components/Tooltip/tooltip */ "./node_modules/@patternfly/react-styles/css/components/Tooltip/tooltip.mjs");
...
/* harmony import */ var _thirdparty_react_popper_usePopper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./thirdparty/react-popper/usePopper */ "./node_modules/@patternfly/react-core/dist/esm/helpers/Popper/thirdparty/react-popper/usePopper.js");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../util */ "./node_modules/@patternfly/react-core/dist/esm/helpers/util.js");
/* harmony import */ var _patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @patternfly/react-styles */ "./node_modules/@patternfly/react-styles/dist/esm/index.js");
...
const Popper = ({ trigger, popper, direction = 'down', position = 'start', placement, width, minWidth = 'trigger', maxWidth, appendTo = 'inline', zIndex = 9999, isVisible = true, positionModifiers, distance = 0, onMouseEnter, onMouseLeave, onFocus, onBlur, onDocumentClick, onTriggerClick, onTriggerEnter, onPopperClick, onPopperMouseEnter, onPopperMouseLeave, onDocumentKeyDown, enableFlip = true, flipBehavior = 'flip', triggerRef, popperRef, animationDuration = 0, entryDelay = 0, exitDelay = 0, onHidden = () => { }, onHide = () => { }, onMount = () => { }, onShow = () => { }, onShown = () => { } }) => {
    ...
    const [popperContent, setPopperContent] = react__WEBPACK_IMPORTED_MODULE_0__.useState(null);
    ...
    const [internalIsVisible, setInternalIsVisible] = react__WEBPACK_IMPORTED_MODULE_0__.useState(isVisible);
    ...
    const internalPosition = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(() => {
    ...
    const onDocumentClickCallback = react__WEBPACK_IMPORTED_MODULE_0__.useCallback((event) => onDocumentClick(event, refOrTrigger, popperElement), [showPopper, triggerElement, refElement, popperElement, onDocumentClick]);
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
        setReady(true);
        onMount();
    }, []);
    ...
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => () => {
        (0,_util__WEBPACK_IMPORTED_MODULE_3__.clearTimeouts)([transitionTimerRef, hideTimerRef, showTimerRef]);
    }, []);
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
        if (triggerRef) {
    ...
    const getPlacementMemo = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(getPlacement, [direction, internalPosition, placement]);
    const getOppositePlacementMemo = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(() => getOppositePlacement(getPlacement()), [direction, internalPosition, placement]);
    const widthMods = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(() => ({
        name: 'widthMods',
    ...
    const { styles: popperStyles, attributes, update, forceUpdate } = (0,_thirdparty_react_popper_usePopper__WEBPACK_IMPORTED_MODULE_4__.usePopper)(refOrTrigger, popperElement, {
    ...
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
        if (prevExitDelayRef.current < exitDelay) {
            (0,_util__WEBPACK_IMPORTED_MODULE_3__.clearTimeouts)([transitionTimerRef, hideTimerRef]);
    ...
    const hide = () => {
        onHide();
        (0,_util__WEBPACK_IMPORTED_MODULE_3__.clearTimeouts)([showTimerRef]);
        hideTimerRef.current = setTimeout(() => {
            setOpacity(0);
            transitionTimerRef.current = setTimeout(() => {
                setInternalIsVisible(false);
    ...
    const options = Object.assign({ className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(popper.props && popper.props.className, positionModifiers && modifierFromPopperPosition()), style: Object.assign(Object.assign(Object.assign({}, ((popper.props && popper.props.style) || {})), popperStyles.popper), { zIndex,
            opacity, transition: getOpacityTransition(animationDuration) }) }, attributes.popper);
    const getMenuWithPopper = () => {
        const localPopper = react__WEBPACK_IMPORTED_MODULE_0__.cloneElement(popper, options);
        return popperRef ? (localPopper) : (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { display: 'contents' }, ref: (node) => setPopperElement(node === null || node === void 0 ? void 0 : node.firstElementChild) }, localPopper));
    };
    const getPopper = () => {
        if (appendTo === 'inline') {
            ...
            return react_dom__WEBPACK_IMPORTED_MODULE_1__.createPortal(getMenuWithPopper(), target);
        }
    };
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
        !triggerRef && trigger && react__WEBPACK_IMPORTED_MODULE_0__.isValidElement(trigger) && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { display: 'contents' }, ref: (node) => setTriggerElement(node === null || node === void 0 ? void 0 : node.firstElementChild) }, trigger)),
        triggerRef && trigger && react__WEBPACK_IMPORTED_MODULE_0__.isValidElement(trigger) && trigger,
