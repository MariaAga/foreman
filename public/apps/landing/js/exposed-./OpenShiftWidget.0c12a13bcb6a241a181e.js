"use strict";
(self["webpackChunklanding"] = self["webpackChunklanding"] || []).push([["exposed-./OpenShiftWidget"],{
...
const OpenShiftWidget = () => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_simple_service_widget__WEBPACK_IMPORTED_MODULE_1__.SimpleServiceWidget, { id: 1, body: "Build, run, and scale container-based applications - now with developer tools, CI/CD, and release management.", linkTitle: "OpenShift", url: "/openshift" })));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (OpenShiftWidget);
...
//# sourceMappingURL=../../sourcemaps/exposed-./OpenShiftWidget.8a5e2aca9da0ae75e3d0f702ddcc299f.js.map